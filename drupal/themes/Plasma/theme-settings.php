 ...
 */
function plasma_form_system_theme_settings_alter(&$form, &$form_state)
{
    $form['plasma_settings']['social_icons'] = array(
        '#type' => 'checkbox',
