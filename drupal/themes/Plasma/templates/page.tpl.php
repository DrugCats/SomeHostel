...
<div id="header-top" class="clearfix">
    <div id="logo"><!--start logo-->
        <div id="site-name"><?php if ($site_name): ?><a href="<?php print $front_page; ?>"
                                                        title="<?php print t('Home'); ?>">
                <h1><?php print $site_name; ?></h1></a><?php endif; ?></div>
    ...
    <?php if (theme_get_setting('social_icons')): ?>
        <ul id="header-social">
            <li><a href="http://www.twitter.com/<?php echo theme_get_setting('twitter_username'); ?>" target="_blank"
                   rel="me"><img src="<?php global $base_url;
                    echo $base_url . '/' . $directory . '/'; ?>/images/twitter.png" alt="twitter"/></a></li>
            <li><a href="http://www.facebook.com/<?php echo theme_get_setting('facebook_username'); ?>" target="_blank"
                   rel="me"><img src="<?php global $base_url;
                    echo $base_url . '/' . $directory . '/'; ?>/images/facebook.png" alt="facebook"/></a></li>
...
<div id="wrapper" class="clearfix">
    ...
    <!-- end main-menu -->
    <div id="content-body">
        <section id="main" role="main" class="clear" style="clear: both;">
        ...
        <section id="right_sidebar_region"><!-- Начало Новый регион  -->
