 ...
 */
function plasma_html_head_alter(&$head_elements)
{
 ...
 */
function plasma_breadcrumb($variables)
{
 ...
 */
function plasma_preprocess_page(&$vars)
{
 ...
 */
function plasma_menu_local_tasks(&$variables)
{
    $output = '';
...
function plasma_preprocess_node(&$variables)
{
    ...
    if ($node_type_suggestion_key !== FALSE) {
        array_splice($variables['theme_hook_suggestions'], $node_type_suggestion_key + 1, 0, array('node__' . $variables['type'] . '__' . $variables['view_mode']));
    }
}

function plasma_preprocess_menu_link(&$vars)
{
